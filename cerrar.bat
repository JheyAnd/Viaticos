...
echo  [3/4] Liberando puerto 8029 (Backend)...
for /f "tokens=5" %%a in ('netstat -aon ^| findstr ":8029 " ^| findstr "LISTENING"') do (taskkill /PID %%a /T /F >nul 2>&1)
